...
export const huggingFaceDefaultModelId: HuggingFaceModelId = "openai/gpt-oss-120b"
...
export const basetenDefaultModelId = "deepseek-ai/DeepSeek-V3-0324" satisfies BasetenModelId
